    ...
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-6">
        <div class="card h-100 shadow-sm border-0">
          <div class="card-header bg-label-primary py-3">
            <h5 class="mb-0 text-primary"><i class="icon-base ti tabler-school me-2"></i>Identitas Lembaga</h5>
          </div>
          <div class="card-body pt-4">
            ...
            <div class="mb-3">
              ...
              <textarea name="alamat_lembaga" rows="2" class="form-control" required>{{ old('alamat_lembaga', $pengaturan['alamat_lembaga']) }}</textarea>
            </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="card h-100 shadow-sm border-0">
          <div class="card-header bg-label-info py-3">
            <h5 class="mb-0 text-info"><i class="icon-base ti tabler-layout-header me-2"></i>Header (KOP) & Logo</h5>
          </div>
          <div class="card-body pt-4">
            <div class="mb-3">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="logo_kiri_url" class="form-control form-control-sm" placeholder="Atau URL" value="{{ str_starts_with($pengaturan['logo_kiri'], 'http') ? $pengaturan['logo_kiri'] : '' }}">
              </div>
              <div class="col-md-6">
                ...
                <input type="text" name="logo_kanan_url" class="form-control form-control-sm" placeholder="Atau URL" value="{{ str_starts_with($pengaturan['logo_kanan'], 'http') ? $pengaturan['logo_kanan'] : '' }}">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="card h-100 shadow-sm border-0">
          <div class="card-header bg-label-success py-3">
            <h5 class="mb-0 text-success"><i class="icon-base ti tabler-user-check me-2"></i>Kepala Sekolah & Legalisasi</h5>
          </div>
          <div class="card-body pt-4">
            <div class="mb-3">
      ...
      <div class="col-12">
        <button type="submit" class="btn btn-primary px-5 shadow">
          <i class="icon-base ti tabler-device-floppy me-2"></i>Simpan Seluruh Pengaturan Lembaga
        </button>
      </div>
    </div>
  </form>
