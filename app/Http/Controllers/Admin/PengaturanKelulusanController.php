...
class PengaturanKelulusanController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $fields = [
            ...
            'teks_penutup', 'nama_kepala_sekolah', 'nip_kepala_sekolah', 'jabatan_penandatangan', 'footer_teks'
        ];
        ...
        foreach ($imageFields as $key => $folder) {
            ...
            elseif ($request->filled($key . '_url')) {
                // Jika input URL diisi, simpan URL-nya
        ...
        return redirect()->route('admin.pengaturan-kelulusan.index')->with('success', 'Seluruh pengaturan PDF (Lokal & External S3) berhasil disimpan.');
    }
