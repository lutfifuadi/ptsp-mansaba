...
@section('title', 'Edit Calon Murid PMBM - Admin')
...
@section('content')
  <div class="header-gradient d-flex justify-content-between align-items-center">
    <div>
      <h4 class="fw-bold mb-1 text-primary">Edit Calon Murid PMBM</h4>
  ...
  <div class="card border-0 shadow-sm" style="border-radius: 4px;">
    <div class="card-header bg-white border-bottom py-3">
      <h5 class="mb-0 fw-bold"><i class="icon-base ti tabler-edit text-primary me-2"></i>Form Edit Calon Murid</h5>
    </div>
    <div class="card-body pt-4">
      <form method="POST" action="{{ route('admin.pmbm.update', $calon->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror"
              value="{{ old('nama_lengkap', $calon->nama_lengkap) }}" placeholder="Nama lengkap calon murid" required style="border-radius: 4px;">
            @error('nama_lengkap')<div class="invalid-feedback">{{ $message }}</div>@enderror
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label fw-bold">NIK <span class="text-danger">*</span></label>
            <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror"
              value="{{ old('nik', $calon->nik) }}" maxlength="16" inputmode="numeric" placeholder="16 digit NIK" required style="border-radius: 4px;">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="no_pendaftaran" class="form-control @error('no_pendaftaran') is-invalid @enderror"
              value="{{ old('no_pendaftaran', $calon->no_pendaftaran) }}" placeholder="Contoh: PMBM-2026-001" required style="border-radius: 4px; border-left: 3px solid #696cff;">
            @error('no_pendaftaran')<div class="invalid-feedback">{{ $message }}</div>@enderror
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label fw-bold">NISN</label>
            <input type="text" name="nisn" class="form-control @error('nisn') is-invalid @enderror"
              value="{{ old('nisn', $calon->nisn) }}" maxlength="10" inputmode="numeric" placeholder="10 digit NISN (Opsional)" style="border-radius: 4px;">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="jalur_pendaftaran" class="form-control @error('jalur_pendaftaran') is-invalid @enderror"
              value="{{ old('jalur_pendaftaran', $calon->jalur_pendaftaran) }}" placeholder="Contoh: Prestasi / Reguler" required style="border-radius: 4px;">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="asal_sekolah" class="form-control @error('asal_sekolah') is-invalid @enderror"
              value="{{ old('asal_sekolah', $calon->asal_sekolah) }}" placeholder="Nama sekolah asal" required style="border-radius: 4px;">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="tempat_tanggal_lahir" class="form-control @error('tempat_tanggal_lahir') is-invalid @enderror"
              value="{{ old('tempat_tanggal_lahir', $calon->tempat_tanggal_lahir) }}" placeholder="Contoh: Bandung, 12 Januari 2012" required style="border-radius: 4px;">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="nama_ortu" class="form-control @error('nama_ortu') is-invalid @enderror"
              value="{{ old('nama_ortu', $calon->nama_ortu) }}" placeholder="Nama Ayah/Ibu" required style="border-radius: 4px;">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="no_hp_calon" class="form-control @error('no_hp_calon') is-invalid @enderror"
              value="{{ old('no_hp_calon', $calon->no_hp_calon) }}" placeholder="Opsional" style="border-radius: 4px;">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="no_hp_ortu" class="form-control @error('no_hp_ortu') is-invalid @enderror"
              value="{{ old('no_hp_ortu', $calon->no_hp_ortu) }}" placeholder="Wajib diisi" required style="border-radius: 4px;">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <select name="status_kelulusan" class="form-select @error('status_kelulusan') is-invalid @enderror" required style="border-radius: 4px; border-left: 4px solid #696cff;">
              <option value="Proses" @selected(old('status_kelulusan', $calon->status_kelulusan) === 'Proses')>Proses</option>
              <option value="Lulus" @selected(old('status_kelulusan', $calon->status_kelulusan) === 'Lulus')>Lulus</option>
              <option value="Tidak Lulus" @selected(old('status_kelulusan', $calon->status_kelulusan) === 'Tidak Lulus')>Tidak Lulus</option>
            </select>
          ...
          <div class="col-md-6 mb-3">
            ...
            <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="1" placeholder="Opsional" style="border-radius: 4px;">{{ old('keterangan', $calon->keterangan) }}</textarea>
