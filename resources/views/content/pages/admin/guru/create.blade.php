...
@section('content')
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="fw-bold mb-1">Tambah Guru</h4>
  ...
  <div class="panel shadow-sm">
    <div class="section-head">
      <h5 class="section-head-title"><span class="dot"></span> Form Tambah Guru</h5>
    </div>
      ...
      <form method="POST" action="{{ route('admin.guru.store') }}">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror"
              value="{{ old('nama_lengkap') }}" placeholder="Nama lengkap guru" required>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="bidang_studi" class="form-control @error('bidang_studi') is-invalid @enderror"
              value="{{ old('bidang_studi') }}" placeholder="Contoh: Matematika" required>
        ...
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="nuptk" class="form-control @error('nuptk') is-invalid @enderror"
              value="{{ old('nuptk') }}" placeholder="Nomor UKG / NUPTK (opsional)">
        ...
        <div class="pt-3 border-top d-flex gap-2">
          <button type="submit" class="btn btn-view">
            <i class="ti tabler-device-floppy me-1"></i> Simpan Data Guru
          </button>
