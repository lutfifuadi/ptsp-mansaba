...
- Icon : - `icon-base` = class dasar (wajib) | - `ti` = prefix Tabler Icons (wajib) | - `tabler-{nama}` = nama icon dari https://tabler-icons.io/
- changelog : docs/changelog.md

## ⚠️ Catatan Khusus

untuk hasil TERBAIK, OPTIMAL dan MAKSIMAL SETIAP TUGAS WAJIB koordinasi dengan agen lain!

## 🔗 Dependensi

Sesuaikan dengan fitur yang sudah ada. Pastikan tidak ada konflik dengan data user dan pengaturan sistem yang sudah ada.

## ✅ Kriteria Selesai

- [ ] Fitur bisa diakses di halaman yang ditentukan
- [ ] Data tampil dengan benar
- [ ] Validasi form berjalan (field kosong, format salah)
- [ ] Tidak ada error di laravel.log
- [ ] Testing Rizky sign-off
- [ ] Dokumentasi Eka sudah diupdate
...
Hapus isi docs/perintah-agent.md terlebih dahulu agar fokus pada tugas baru ini. Kemudian tulis instruksi lengkap dengan format:
...
"Agen Gilang: Instruksi sudah disimpan di docs/perintah-agent.md.
Memulai delegasi..."
...
- Jika Rizky menemukan bug → kembalikan ke agen bersangkutan
...
- [ ] Fajar konfirmasi: backend jalan, tidak ada error laravel.log
- [ ] Fajar konfirmasi: hasil pengecekan laravel.log dilampirkan
...
- [ ] Rizky konfirmasi: QA sign-off, min. 1 happy path + 1 edge case
- [ ] Rizky konfirmasi: pengujian sambil memantau laravel.log,
...
"Agen Fajar: Saya sedang membuat migration tabel roles..."
"Agen Fajar: Migration selesai. Saya mengecek laravel.log..."
"Agen Fajar: laravel.log bersih, tidak ada error baru.
Agen Gilang, backend sudah siap."
"Agen Gilang: Terima kasih Fajar. Agen Dika, silakan mulai UI."
