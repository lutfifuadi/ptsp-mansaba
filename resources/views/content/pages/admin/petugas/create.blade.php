...
@section('content')
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="fw-bold mb-1">Tambah Petugas</h4>
  ...
  <div class="panel shadow-sm">
    <div class="section-head">
      <h5 class="section-head-title"><span class="dot"></span> Form Tambah Petugas</h5>
    </div>
      ...
      <form method="POST" action="{{ route('admin.petugas.store') }}">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror"
              value="{{ old('nama_lengkap') }}" placeholder="Nama lengkap petugas" required>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="no_whatsapp" class="form-control @error('no_whatsapp') is-invalid @enderror"
              value="{{ old('no_whatsapp') }}" placeholder="Contoh: 628123456789" required>
        ...
        <div class="mb-3">
          ...
          <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="2"
            placeholder="Jabatan atau keterangan tambahan (opsional)">{{ old('deskripsi') }}</textarea>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="form-check">
                <input type="checkbox" name="layanan_id[]" class="form-check-input" id="layanan_{{ $l->id }}"
                  value="{{ $l->id }}" {{ in_array($l->id, old('layanan_id', [])) ? 'checked' : '' }}>
        ...
        <div class="pt-3 border-top d-flex gap-2">
          <button type="submit" class="btn btn-view">
            <i class="ti tabler-device-floppy me-1"></i> Simpan Data Petugas
          </button>
