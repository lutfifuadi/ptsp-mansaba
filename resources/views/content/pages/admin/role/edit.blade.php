    ...
    <div class="panel-body pt-4">
      <form method="POST" action="{{ route('admin.role.update', $user->id) }}">
        ...
        <div class="mb-4">
          ...
          <div class="row g-3">
            <div class="col-md-4">
              <div class="role-select-card @if(old('role', $user->role) === 'admin') active @endif" data-value="admin" onclick="selectRole(this)">
            ...
            <div class="col-md-4">
              <div class="role-select-card @if(old('role', $user->role) === 'staff') active @endif" data-value="staff" onclick="selectRole(this)">
            ...
            <div class="col-md-4">
              <div class="role-select-card @if(old('role', $user->role) === 'user') active @endif" data-value="user" onclick="selectRole(this)">
