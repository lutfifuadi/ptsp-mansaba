        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="no_peserta_ujian" class="form-control @error('no_peserta_ujian') is-invalid @enderror"
              value="{{ old('no_peserta_ujian', $siswa->no_peserta_ujian) }}" placeholder="Contoh: 24-10-19-3-0064-0001" style="border-radius: 4px;">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="madrasah_asal" class="form-control @error('madrasah_asal') is-invalid @enderror"
              value="{{ old('madrasah_asal', $siswa->madrasah_asal) }}" placeholder="Nama sekolah asal" style="border-radius: 4px;">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <select name="tipe_kelulusan" class="form-select @error('tipe_kelulusan') is-invalid @enderror" required style="border-radius: 4px; border-left: 4px solid #00cfe8;">
              <option value="XII" @selected(old('tipe_kelulusan', $siswa->tipe_kelulusan) === 'XII')>Kelas XII</option>
              <option value="PMBM" @selected(old('tipe_kelulusan', $siswa->tipe_kelulusan) === 'PMBM')>PMBM</option>
            </select>
